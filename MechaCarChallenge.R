...
t.test(sample_table$PSI,mu=mean(table_coil$PSI)) #compare means of two samples
t.test(sample_table$PSI,mu=mean(table_coil$PSI),subset(sample_table,Manufacturing_Lot=='Lot1'))#compare means of two samples
t.test(table_coil$PSI,mu=1500,subset=Manufacturing_Lot=='Lot2')#compare means of two samples
t.test(sample_table$PSI,mu=1500,subset=Manufacturing_Lot=='Lot3')#compare means of two samples
?subset()
